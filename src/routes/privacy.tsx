...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | RegPromo Lens" },
      {
        name: "description",
        content:
          "How RegPromo Lens protects personal data in line with UK GDPR and the Data Protection Act 2018.",
      },
      { property: "og:title", content: "Privacy Policy | RegPromo Lens" },
      {
      ...
      <section className="sec sec-top">
        <div className="container">
          ...
          <p className="lede" style={{ maxWidth: 640 }}>
            Last updated July 2026. RegPromo Lens is committed to protecting personal data in line
